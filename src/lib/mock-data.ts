...
export const members: Member[] = [
  {
    ...
    firstName: "Nathaniel",
    lastName: "Ellacer",
    email: "nathanielellacer.v@bai.edu",
  ...
  {
    userId: "FAC-00042",
    firstName: "Dr. Laurice",
    lastName: "Laureta",
    email: "l.laureta@bai.edu",
